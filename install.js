...
console.log(color('\n🐶 YT CHANNEL: Queen-Alexa ','silver'))
console.log(color('🐶 GITHUB: Queen-Alexa ','silver'))
console.log(color('🐶 WA NUMBER: +94702256963 ','silver'))
console.log(color('  🦄Alexa system. 2022🦄','mediumseagreen'))
    ...
    console.log(color('🐶', 'cyan'), color('https://wa.me/94702256963'))
    console.log(color('🐶', 'cyan'), color('Alexa Bot Is On...', 'pink'))
...
require("./run")(XeonBotInc, m, chatUpdate, store)
} catch (err) {
console.log(err)
}
})
