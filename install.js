...
require('./settings')
const { default: NexusNwIncConnect, useSingleFileAuthState, DisconnectReason, fetchLatestBaileysVersion, generateForwardMessageContent, prepareWAMessageMedia, generateWAMessageFromContent, generateMessageID, downloadContentFromMessage, makeInMemoryStore, jidDecode, proto, MessageType } = require("@adiwajshing/baileys")
...
💔people come and go,that's life.` })
    ...
    WhatsAlexa.send5ButImg = async (jid , text = '' , footer = '', img, but = [], options = {}) =>{
        ...
        imageMessage: message.imageMessage,
            ...
            WhatsAlexa.relayMessage(jid, template.message, { messageId: template.key.id })
    }
